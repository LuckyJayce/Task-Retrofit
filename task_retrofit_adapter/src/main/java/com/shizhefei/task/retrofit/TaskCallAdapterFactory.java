...
public final class TaskCallAdapterFactory extends CallAdapter.Factory {
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        boolean isLinkTask = rawType == LinkTask.class;
        if (!isIAsyncTask && !isLinkTask) {
            return null;
        }
        ...
        if (!(returnType instanceof ParameterizedType)) {
            String name = isIAsyncTask ? "IAsyncTask" : "LinkTask";
        ...
        return new TaskCallAdapter(responseType, isResult, isBody);
    }
}